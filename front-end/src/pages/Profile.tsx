                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-4 align-self-center">
                        <div className="main-info header-text">
                          ...
                          <p>"I'm {user.firstName}, a passionate manga reader who loves discovering new series and stories. Let's explore the manga world together!"</p>
